...
export const metadata = {
  title: "Partner Kami",
  description: "Daftar partner Toko Ponpes untuk kebutuhan Pondok Pesantren.",
};

export default function MitraListPage() {
  return (
    <div className="bg-neutral-50 min-h-screen">
      <section className="bg-gradient-to-br from-brand-primary to-green-800 text-white">
        <div className="container-page py-16 lg:py-20 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto leading-relaxed">
            Jaringan mitra terpercaya Toko Ponpes untuk menyediakan produk pendidikan, alat tulis, dan perlengkapan pesantren berkualitas.
          </p>
        </div>
      </section>
